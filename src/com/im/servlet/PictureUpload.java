...
public class PictureUpload extends HttpServlet{
    ...
    private String getFilename(Part part){
        ...
        // 返回不带路径的文件名
        fname = "." + header.substring(header.lastIndexOf(".")+1, 
                                 header.length()-1);
        return fname;
    }
	...
	public void doPost(HttpServletRequest request, 
        ...
        p.write(pa);     // 将上传的文件写入磁盘
         ...
         data.setCode(0);
        // data.setMsg("上传成功!"+"url:http://139.196.103.219:8080/Picture"+"/"+type+"/"+fname);
         data.setMsg("上传成功!"+"url:http://10.0.2.2:8080/IM/DrugPicture"+"/"+fname);
        // String url = "http://139.196.103.219:8080/Picture"+"/"+type+"/"+fname;
         String url;
         ...
         try {
	         if(id != null || !(id.equals(""))) {
	        	 ...
	        	 url="http://127.0.0.1:8080/IM/StuIcon"+"/"+fname;
	        		 ...
	        		 url="http://127.0.0.1:8080/IM/DocIcon"+"/"+fname;
	        		 DBUtils a = new DBUtils();
	 	 	        a.openConnect();
	        		 ...
	        		 url="http://127.0.0.1:8080/IM/DocLicenseIcon"+"/"+fname;
	        		 DBUtils a = new DBUtils();
	 	 	        a.openConnect();
